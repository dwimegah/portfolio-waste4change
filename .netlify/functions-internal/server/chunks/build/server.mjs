...
import { inject, computed, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowRef, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, ref, Suspense, Fragment, createApp, createVNode, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { y as hasProtocol, z as isScriptProtocol, x as joinURL, A as withQuery, B as sanitizeStatusCode, C as getContext, D as parsePath, E as parseQuery, $ as $fetch$1, F as baseURL, G as createHooks, s as createError$1, H as defu, I as executeAsync, J as getRequestURL, K as getRequestHeader, L as getCookie, M as klona, v as destr, N as isEqual, O as createDefu, P as setCookie, Q as deleteCookie, R as withoutTrailingSlash, S as isEqual$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-emjP7vYE.mjs')
  },
  {
    name: "index___id",
    path: "/id",
  ...
  id: [
    {
      ...
      load: () => import(
        './id-DyRmU71L.mjs'
        /* webpackChunkName: "locale_id_46json_1309b210" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        './en-8aztJxmQ.mjs'
        /* webpackChunkName: "locale_en_46json_9b7e9a01" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/hXe_5IxT"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/hXe_5IxT"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-2sQWWmUr.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DzBb8pGb.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-kNVZcYpz.mjs'));
...
export { _export_sfc as _, useI18n as a, useSwitchLocalePath as b, useRouter as c, useNuxtApp as d, entry_default as default, useRuntimeConfig as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, useHead as u };
