...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "d2bbc222-bbb8-4452-9c4e-6341981819bc",
...
const localeLoaders = {
  id: [
    {
      key: "locale_id_46json_1309b210",
      load: () => import('./id.mjs' /* webpackChunkName: "locale_id_46json_1309b210" */),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_9b7e9a01",
      load: () => import('./en.mjs' /* webpackChunkName: "locale_en_46json_9b7e9a01" */),
      cache: true
    }
  ]
};
...
const _GhhQOryAHl0LwOJvtiBOCqzwGo_LL7I5ymfq4Jvovs = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/hXe_5IxT") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const plugins = [
  _GhhQOryAHl0LwOJvtiBOCqzwGo_LL7I5ymfq4Jvovs
];
...
const _Wku0Mb = _messagesHandlerCached;

const _lazy_WAtijG = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_WAtijG, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _Wku0Mb, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_WAtijG, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, withQuery as A, sanitizeStatusCode as B, getContext as C, parsePath as D, parseQuery as E, baseURL as F, createHooks as G, defu as H, executeAsync as I, getRequestURL as J, getRequestHeader as K, getCookie as L, klona as M, isEqual as N, createDefu as O, setCookie as P, deleteCookie as Q, withoutTrailingSlash as R, isEqual$1 as S, withTrailingSlash as T, appRootTag as a, appRootAttrs as b, buildAssetsURL as c, appSpaLoaderTag as d, appSpaLoaderAttrs as e, useRuntimeConfig as f, getRouteRulesForPath as g, getResponseStatusText as h, getResponseStatus as i, joinHeaders as j, appId as k, decodePath as l, defineRenderHandler as m, normalizeCookieHeader as n, appTeleportTag as o, publicAssetsURL as p, appTeleportAttrs as q, getQuery as r, createError$1 as s, appHead as t, useNitroApp as u, destr as v, getRouteRules as w, joinURL as x, hasProtocol as y, isScriptProtocol as z };
